...
Welcome to the **Blust AI Studio** documentation hub. This documentation is designed for both _beginners_ and _experienced developers_.  
...
Using AI tools consumes credits from the user's account. Each action performed deducts a specific number of credits based on the _tool's usage price_.
...
Please manage your credits wisely and monitor your usage to optimize your experience on blust.AI. For more information on credit pricing and subscription tiers, visit our [Pricing Page](https://blust.ai/#blust-ai-pricing).

## Adding AI Tools: Two Starting Points

There are two main ways to add AI tools to the blust.AI:

## Option 1: Create a New AI Tool

Blust AI Studio's no-code environment and pre-built models _simplify_ the creation of new AI tools. Here’s how you can get started:
...
4. Customize your AI tool or add additional capabilities to meet your specific requirements.
...
1. Implement _OAuth 2.0_ within your App to securely handle user authentication.
2. Develop functions within your backend to _track_ and _report_ usage information back to blust.AI.
...
Should you have any questions or require assistance, please reach out to our support team.
