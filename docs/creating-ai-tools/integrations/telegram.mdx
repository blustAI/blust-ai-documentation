...
**To make your bot free for all Telegram users**, enable `allow guests` and ensure your AI tool is set to _free for users_ in the [Configuration](./../configuration) section.

If you're part of the monetization program and want to earn from ALL interactions, disable `allow guests` and configure your AI tool as _premium_ in the [Configuration](./../configuration) section. In this case, only Blust AI users with a paid subscription will be able to interact with your bot; others will receive an error message.
